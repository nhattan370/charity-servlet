...
<head>
	...
	<c:if test="${not empty sessionScope.donate}">
		<div class="toast" data-delay="1000" style="position:fixed; top: 100PX; left: 40PX;z-index: 2000;width: 300px">
		  <script>
		    swal({
		      title: "${donate} ? 'Donate Successfully!'",
		      text: 'Redirecting...', 
        ...
        <div class="col-lg-6">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              ...
              <li class="mb-2"><strong class="text-black">Tên đợt quyên góp:</strong>${name}</li>
              ...
              <li class="mb-2"><strong class="text-black">Trạng thái
              		<c:if test="${donation.status==1}">Mới tạo</c:if>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <input type="text" class="form-control"
                         id="addname" name="name" placeholder="Nguyen Van A" required>
