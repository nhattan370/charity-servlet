      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="pt-5">
            ...
            <h3 class="mb-5">${usersForDonation.size()}</h3>
            
            <ul class="comment-list">
	            <c:forEach var="userDonation" items="${usersForDonation}">
	                <li class="comment">
	                  <div class="vcard bio">
        ...
        <div class="col-lg-6">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              ...
              <li class="mb-2"><strong class="text-black">Trạng thái:

              </strong>
              	    <c:if test="${donation.status==1}"><span>Mới tạo</span></c:if>
              	    <c:if test="${donation.status==2}"><span>Đang quyên góp</span></c:if>
              		<c:if test="${donation.status==3}"><span>Tạm dừng</span></c:if>
              		<c:if test="${donation.status==4}"><span>Kết thúc</span></c:if>
              </li>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Quyên góp<span style="color:#e67e22">${donation.name}</span></h5>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <input type="number" class="form-control"
                         id="add-donate" name="money" required>
                  <input type="hidden" class="form-control" value="${donation.id }"
                         id="idDonation" name="idDonation">
                  <input type="hidden" class="form-control" value="1"
                         id="idUser" name="idUser">
                  <input type="hidden" class="form-control" value="detail"
                         id="detail-path" name="path" required>

                  <label for="mesage"
                         class="col-form-label">Lời nhắn:</label>
                  <textarea rows="10" cols="3" id="message" class="form-control" name="text">
